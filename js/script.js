...
document.addEventListener('click', function (e) {
   if (menuNav.classList.contains('active') && !e.target.closest('.btn-burger-menu, .header-menu') ) {
		btnBurger.classList.remove('active');
		menuNav.classList.remove('active');
      body.classList.remove('lock');
   }
	if (headerSearch.classList.contains('active') && !e.target.closest('.header-search, .header-menu__link_btn-search')) {
